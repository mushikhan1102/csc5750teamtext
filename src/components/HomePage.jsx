...
const HomePage = () => {
  return (
    <div>
      ...
      <main>
        <p>Welcome to Team Text. This website is made to message anyone that registers to it. Click on Register on the top right to get started. Fill in the information there. 
